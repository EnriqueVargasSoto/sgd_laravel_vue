<script setup>
    ...
    const onSubmit = async() => {
        try {
            if (!props.dato) {
                ...
                Swal.fire({
                    title: '¡Éxito!',
                    text: 'La importancia se ha agregado correctamente.',
                    icon: 'success',
                ...
                Swal.fire({
                    title: '¡Éxito!',
                    text: 'La importancia se ha actualizado correctamente.',
                    icon: 'success',
                    confirmButtonText: 'OK',
                    buttonsStyling: false, // Desactiva los estilos predeterminados
                    customClass: {
            ...
            Swal.fire({
                title: 'Error',
                text: 'Hubo un problema al agregar la estado.',
                icon: 'error',
    ...
    watch(() => props.dato, (newDato) => {
        importancia.value = newDato?.importancia || ''
