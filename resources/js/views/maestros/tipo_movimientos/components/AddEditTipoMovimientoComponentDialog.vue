    ...
    const onSubmit = async() => {
        try {
            if (!props.dato) {
                ...
                Swal.fire({
                    title: '¡Éxito!',
                    text: 'El tipo de documento se ha agregado correctamente.',
                    icon: 'success',
            ...
            Swal.fire({
                title: 'Error',
                text: 'Hubo un problema al agregar el tipo de documento.',
                icon: 'error',
        ...
        <VCard class="pa-2 pa-sm-10">
            <VCardText>
                ...
                <h4 class="text-h4 text-center mb-2">
                    {{ props.dato ? 'Editar' : 'Agregar Nuevo' }} Tipo de Movimiento
                </h4>
                ...
                <VForm  style="text-align: center;">
                   <!--  <VAlert
                    ...
                    <div class="d-flex gap-4 mb-6 flex-wrap flex-column flex-sm-row">
                        <AppTextField
                            v-model="tipo"
                            placeholder="Nombre de Tipo de Documento"
                        />
                    </div>
                    <!-- 👉 Role name -->
                    <!-- <div class="d-flex gap-4 mb-6 flex-wrap flex-column flex-sm-row">
