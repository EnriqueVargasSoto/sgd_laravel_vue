            ...
            try {
                if (!props.dato) {
                    const { data, error } = await useApi(`/${props.endpoint}`, {
                        ...
                        body: JSON.stringify(tipo_derivacion.value),
                    });
        ...
        <VCard class="pa-2 pa-sm-10">
            <VCardText>
                ...
                <h4 class="text-h4 text-center mb-2">
                    {{ props.dato ? 'Editar' : 'Agregar Nuevo' }} Tipo de Derivacion
                </h4>
                ...
                <VForm  ref="refVForm" @submit.prevent="onSubmit">
                    ...
                    <div class="d-flex gap-4 mb-6 flex-wrap flex-column flex-sm-row">
                        <AppTextField
                            v-model="tipo_derivacion.derivacion"
                            placeholder="Tipo de Derivacion"
                    ...
                    <div class="d-flex gap-4 mb-6 flex-wrap flex-column flex-sm-row">
                        <AppTextField
                            v-model="tipo_derivacion.niveles"
                            placeholder="Niveles"
                            :rules="[rules.required]"
                        />
                    </div>
