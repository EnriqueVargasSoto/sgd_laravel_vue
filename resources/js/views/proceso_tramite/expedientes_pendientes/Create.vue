<script setup>
import DealDetails from '@/views/proceso_tramite/expedientes_pendientes/components/create-deal/DealDetails.vue'
import DealReviewComplete from '@/views/proceso_tramite/expedientes_pendientes/components/create-deal/DealReviewComplete.vue'
import CreateDealType from '@/views/proceso_tramite/expedientes_pendientes/components/create-deal/DealType.vue'
import DealUsage from '@/views/proceso_tramite/expedientes_pendientes/components/create-deal/DealUsage.vue'
