...
use Modules\Maestros\Models\Prioridad;
...
class PrioridadController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            $query = Prioridad::/* with('submodulos', 'moduloPadre', 'permisos')-> */orderBy('id', 'asc');

            // Aplicar la búsqueda si se proporciona un término
            if ($search) {
                $query->where(function ($query) use ($search) {
                    $query->where('prioridad', 'like', '%' . $search . '%');
    ...
    public function store(Request $request)
    {
        try {
            ...
            return response()->json(['data' => $prioridad, 'mensaje' => 'Prioridad '.$prioridad->prioridad.' creado con éxito']);
        } catch (\Error $e) {
            //throw $th;
            return response()->json(['error' => $e]);
        }
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            $prioridad->slug = $request->slug;
            $prioridad->save();

            return response()->json(['data' => $prioridad, 'mensaje' => 'Prioridad '.$prioridad->prioridad.' actualizado con éxito']);
        } catch (\Error $e) {
            //throw $th;
            return response()->json(['error' => $e]);
        }
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            return response()->json(['data' => 'registro '.$prioridad->prioridad.' eliminado']);
        } catch (\Error $e) {
            //throw $th;
            return response()->json(['error' => $e]);
        }
